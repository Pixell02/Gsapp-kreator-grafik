...
export const layersName = [
  ...
  {name: "pełne nazwy gospodarza", type: "multiplyImage", text: "Twoja drużyna", className: "yourTeamNameOne"},
  {name: "pełne nazwy przeciwników", type: "multiplyImage", text: "Twój przeciwnik", className: "yourOpponentNameOne"},
  { name: "wyniki", type: "multiplyText", text: "8:8", className: "connectedResultsOne" },
