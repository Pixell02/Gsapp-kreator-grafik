...
export default function MultiplyProperties({coords, handleSelectChange,handleSelectGroupChange, handleInputChange, updateActiveGroupObjectCoords}) {
  ...
  return (
    ...
    <div className="d-flex">
      <div>
        X: <input type="number" value={coords.left} className="w-75" name="left" onChange={updateActiveGroupObjectCoords} />
      </div>
      <div>
        Y: <input type="number" value={coords.top} className="w-75" name="top" onChange={updateActiveGroupObjectCoords} />
      </div>
    </div>
    <div className="d-flex w-100">
      ...
      <div className="d-flex mx-2 w-100 align-items-center justify-content-start">
        <div className='d-flex w-50'>
          kolor: <input type="color" value={coords.fill} className="w-50" name="fill" onChange={updateActiveGroupObjectCoords} />
        </div>
        <div className='d-flex w-50'>
          odstęp: <input type="number" value={coords.Margin} defaultValue={20} className="w-50" name="Margin" onChange={updateActiveGroupObjectCoords} />
        </div>
    </div>
    <div className="d-flex w-100 mt-2">
      ...
      <div className="w-100 ml-1">
        rozmiar czcionki :{" "}
        <input type="number" className="w-50" defaultValue={20} name="fontSize" value={coords.fontSize} onChange={updateActiveGroupObjectCoords } />
      </div>
      </div>
      <div className='w-100'>
        format: 
