      ...
      {data && editLicense && (
        <div className="d-flex h-100 position-absolute w-100 justify-content-center align-items-center">
          <LicenseEdit
            ...
            License={data}
            open={editLicense}
            onClose={(e) => setEditLicense(false)}
          />
        </div>
      )}
      ...
      <div className="ml-2 d-flex flex-column w-100">
            ...
            props.user.map((user) => (
              <div className="profile-image-name d-flex flex-column">
                ...
                <div className="btn-container w-100">
                  <button
                    onClick={(e) => editClick(e, user)}
                    className="mx-1 w-100 btn btn-primary">
                    Edytuj
                  </button>
                </div>
              </div>
        ...
        <div>
          <div className="yourPoster-container">
            ...
            <button
              className="btn ml-5 w-25 mt-2"
              onClick={(e) => handleEditLicense(e, props.License)}>
              Edytuj
            </button>
                    ...
                    <Link to={`/${language}/creator/${userPoster.uuid}`}>
                      ...
                      <div className="image-category-content">
                        {userPoster.src && (
                          <img
                            src={userPoster.src}
                            alt={userPoster.firstName + ' ' + userPoster.secondName}
                          />
                        )}
                      </div>
                    </Link>
          ...
          <div className="players-container">
            ...
            <div className="btn-container ml-5">
              <button
                onClick={() => setOpenOpponentModal(true)}
                className="btn primary-btn">
                Dodaj Przeciwnika
              </button>
            </div>
