...
import useTeamContext from '../../Creator/hooks/useTeamContext';
...
const EditSquadPlayersPresetWindow = ({ onClose, Players, data }) => {
  ...
  console.log(capitan, goalkeeper)
  const handleSave = () => {
  ...
  return (
    ...
    <div className="add-window yourTeam-panel-window">
      ...
      {selectedWindow === 1 && (
        <div className="mb-5">
            <span>Kapitan</span>
            <select className="form-control" value={capitan} onChange={(option) => console.log(option)}>
