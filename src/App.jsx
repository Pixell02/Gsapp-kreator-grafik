      ...
      <BrowserRouter>
        {authIsReady && (
          <Routes>
            ...
            <Route
              path="/:lang/catalog"
              element={user ? <Catalog /> : <Navigate to={`/${language}/login`} />}
            />
            <Route
            ...
            <Route
              path="/:lang/players"
              element={user ? <Players /> : <Navigate to={`/${language}/login`} />}
            />
            <Route
              path="/:lang/opponents"
              element={user ? <Opponents /> : <Navigate to={`/${language}/login`} />}
            />
            <Route
              path="/:lang/sponsors"
              element={user ? <Sponsors /> : <Navigate to="/login" />}
            />
            <Route
              path="/success"
              element={user ? <Success /> : <Navigate to={`/${language}/login`} />}
            />
            <Route
              path="/success/*"
              element={user ? <Success /> : <Navigate to={`/${language}/login`} />}
            ...
            <Route
              path="/:lang/offer"
              element={user ? <Offer /> : <Navigate to={`/${language}/login`} />}
            />

            <Route
              path="/:lang/account"
              element={user ? <Account /> : <Navigate to={`/${language}/login`} />}
            />
            <Route
            ...
            <Route
              path="/:lang/guide"
              element={user ? <Guide /> : <Navigate to={`/${language}/login`} />}
            />
            <Route
              path="/:lang/dataPrivacy"
              element={<DataPrivacy />}
            />
            <Route
              path="/:lang/stats"
              element={user ? <Stats /> : <Navigate to={`/${language}/login`} />}
            />
            {user &&
              (user.uid === 'hgwaMbxg3qWnQyqS44AtyTrkSA93' ||
                ...
                <>
                  ...
                  <Route
                    ...
                    element={user ? <EditPoster /> : <Navigate to={`/${language}/login`} />}
                  />
                  <Route
                    path="/:lang/posterCreator/theme"
                    element={user ? <ThemeCreator /> : <Navigate to={`/${language}/login`} />}
                  />
                  <Route
                    path="/:lang/posterCreator/theme/:id"
                    element={user ? <EditTheme /> : <Navigate to={`/${language}/login`} />}
                  />
                </>
              )}
