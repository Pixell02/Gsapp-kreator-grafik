        ...
        <Routes>
          ...
          {user && (user.uid === "hgwaMbxg3qWnQyqS44AtyTrkSA93" || user.uid === "6vVYzE860LS6Ua4nIIfCSul7feD2" ||  user.uid === "ait7T01TWaPDqx3a4YsogOQrL4O2") && (
            <>
              ...
              <Route path="/:lang/posterCreator" element={user ? <PosterCreator /> : <Navigate to={`/${language}/login`}  />} />
              <Route path="/:lang/stats/:id" element={user ? <UserAccount /> : <Navigate to={`/${language}/login`}  />} />
              <Route path="/:lang/posterCreator/:id" element={user ? <EditPoster /> : <Navigate to={`/${language}/login`}  />} />
              <Route path="/:lang/posterCreator/theme" element={user ? <ThemeCreator /> : <Navigate to={`/${language}/login`}  />} />
